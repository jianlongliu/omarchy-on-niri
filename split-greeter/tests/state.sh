...
run_case "double-face-request" jianlongliu "--howdy-fail" \
...
run_case "stalled+typed-password" jianlongliu "--hang-face 8" \
...
run_case "stalled+watchdog" jianlongliu "--hang-face 8" \
...
run_case "switch-during-stall" yvonne "--hang-face 8" \
...
run_case "stalled+nothing-typed" jianlongliu "--hang-face 8" "GREETER_ATTEMPT_TIMEOUT_MS=2000" no yes 7
